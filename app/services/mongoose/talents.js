...
const updateTalents = async (req) => {
  ...
  if (check) throw new NotFoundError(`Pembicara sudah terdaftar`);

  const result = await Talents.findByIdAndUpdate({ _id: id }, { name, image, role, organizer: req.user.organizer }, { new: true }, { runValidators: true });
